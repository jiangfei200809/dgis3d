define(["/assets/modules/dgis3d"], function (dgis3d) {
    ...
    main.desktop = function () {
        ...
        return;
        dgis3d.geometry.model(70, 30, 40, "../assets/models/desktop/desk/desk.mtl", "../assets/models/desktop/desk/desk.obj", 0, 0, 0, {
            x: 470,
            y: 50,
            z: 5
        }, function (obj) {
        ...
        dgis3d.geometry.model(30, 30, 50, "../assets/models/desktop/chair/chair.mtl", "../assets/models/desktop/chair/chair.obj", 0, Math.PI / 2, 0, {
            x: 420,
            y: 85,
            z: 5
        }, function (obj) {
        ...
        dgis3d.geometry.model(10, 15, 10, "../assets/models/pc/macbook/macbook.mtl", "../assets/models/pc/macbook/macbook.obj", 0, Math.PI / 2, 0, {
            x: 430,
            y: 60,
            z: 45
        }, function (obj) {
        ...
        dgis3d.geometry.model(20, 15, 15, "../assets/models/pc/mac/mac.mtl", "../assets/models/pc/mac/mac.obj", 0, 0, 0, {
            x: 495,
            y: 60,
            z: 45
        }, function (obj) {
        ...
        dgis3d.geometry.model(5, 15, 5, "../assets/models/camare/hk/hk.mtl", "../assets/models/camare/hk/hk.obj", Math.PI / 4, Math.PI / 4, 0, {
            x: 8,
            y: 5,
            z: 80
        }, function (obj) {
