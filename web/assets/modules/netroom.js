define(["/assets/modules/dgis3d"], function (dgis3d) {
    ...
    main.wall = function () {
        ...
        var midGlassBottomMesh4 = dgis3d.geometry.mesh(dgis3d.geometry.box(5, 110, 5), {
            x: 490,
            y: 530,
            z: 0
        }, wallBottomMaterial);
        ...
        var midGlassBottomMesh5 = dgis3d.geometry.mesh(dgis3d.geometry.box(135, 5, 5), {
            x: 355,
            y: 530,
            z: 0
        }, wallBottomMaterial);
        ...
        var midGlassBottomMesh6 = dgis3d.geometry.mesh(dgis3d.geometry.box(15, 5, 5), {
            x: 250,
            y: 530,
            z: 0
        }, wallBottomMaterial);
        ...
        var midGlassBottomMesh7 = dgis3d.geometry.mesh(dgis3d.geometry.box(15, 5, 5), {
            x: 350,
            y: 130,
            z: 0
        }, wallBottomMaterial);
        ...
        var midGlassBottomMesh8 = dgis3d.geometry.mesh(dgis3d.geometry.box(200, 5, 5), {
            x: 415,
            y: 130,
            z: 0
        }, wallBottomMaterial);
        ...
        var midGlassBottomMesh9 = dgis3d.geometry.mesh(dgis3d.geometry.box(5, 40, 5), {
            x: 615,
            y: 95,
            z: 0
        }, wallBottomMaterial);
        ...
        var midGlassMesh4 = dgis3d.geometry.mesh(dgis3d.geometry.box(200, 1, h - 5), {
            x: 415,
            y: 130,
            z: 5
        }, glassMaterial);
        ...
        var midGlassMesh5 = dgis3d.geometry.mesh(dgis3d.geometry.box(1, 35, h - 5), {
            x: 615,
            y: 99,
            z: 5
        }, glassMaterial);
        ...
        var midGlassMesh6 = dgis3d.geometry.mesh(dgis3d.geometry.box(1, 108, h - 5), {
            x: 490,
            y: 532,
            z: 5
        }, glassMaterial);
        ...
        var midGlassMesh7 = dgis3d.geometry.mesh(dgis3d.geometry.box(137, 1, h - 5), {
            x: 355,
            y: 532,
            z: 5
        }, glassMaterial);
        ...
        var midGlassMesh8 = dgis3d.geometry.mesh(dgis3d.geometry.box(10, 1, h - 5), {
            x: 255,
            y: 532,
            z: 5
        }, glassMaterial);
        ...
        var midGlassMesh9 = dgis3d.geometry.mesh(dgis3d.geometry.box(10, 1, h - 5), {
            x: 355,
            y: 132,
            z: 5
        }, glassMaterial);
    ...
    main.desktop = function () {
        dgis3d.geometry.model(70, 30, 40, "../assets/models/desktop/desk/desk.mtl", "../assets/models/desktop/desk/desk.obj", {
            x: 0,
            y: 0,
            z: 0
        }, {x: 400, y: 50, z: 5}, function (obj) {
        ...
        dgis3d.geometry.model(70, 30, 40, "../assets/models/desktop/desk/desk.mtl", "../assets/models/desktop/desk/desk.obj", {
            ...
            y: 0,
            z: 0
        }, {x: 540, y: 50, z: 5}, function (obj) {
            dgis3d.scene.add(obj);
            dgis3d.render();
        });

        dgis3d.geometry.model(30, 30, 50, "../assets/models/desktop/chair/chair.mtl", "../assets/models/desktop/chair/chair.obj", {
            x: 0,
            y: Math.PI / 2,
            z: 0
        }, {x: 420, y: 85, z: 5}, function (obj) {
            dgis3d.scene.add(obj);
            dgis3d.render();
        });
        ...
        dgis3d.geometry.model(30, 30, 50, "../assets/models/desktop/chair/chair.mtl", "../assets/models/desktop/chair/chair.obj", {
            ...
            y: Math.PI / 2,
            z: 0
        }, {x: 560, y: 85, z: 5}, function (obj) {
            dgis3d.scene.add(obj);
            dgis3d.render();
        });

        dgis3d.geometry.model(10, 15, 10, "../assets/models/pc/macbook/macbook.mtl", "../assets/models/pc/macbook/macbook.obj", {
            x: 0,
            y: Math.PI / 2,
            z: 0
        }, {x: 430, y: 60, z: 45}, function (obj) {
            dgis3d.scene.add(obj);
            dgis3d.render();
        });

        dgis3d.geometry.model(20, 15, 15, "../assets/models/pc/mac/mac.mtl", "../assets/models/pc/mac/mac.obj", {
            x: 0,
            y: 0,
            z: 0
        }, {x: 495, y: 60, z: 45}, function (obj) {
            dgis3d.scene.add(obj);
            dgis3d.render();
        });
        ...
        dgis3d.geometry.model(20, 15, 15, "../assets/models/pc/mac/mac.mtl", "../assets/models/pc/mac/mac.obj", {
            ...
            y: 0,
            z: 0
        }, {x: 570, y: 60, z: 45}, function (obj) {
            dgis3d.scene.add(obj);
            dgis3d.render();
        });

        dgis3d.geometry.model(5, 15, 5, "../assets/models/camare/hk/hk.mtl", "../assets/models/camare/hk/hk.obj", {
            x: Math.PI / 4,
            y: Math.PI / 4,
            z: 0
        }, {x: 8, y: 5, z: 80}, function (obj) {
            dgis3d.scene.add(obj);
            dgis3d.render();
        });
